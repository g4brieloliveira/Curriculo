  ...
  return (
    <div className="about">
      ...
      <div className="aboutContent">
        ...
        <p>Olá, meu nome é Gabriel Augusto de Oliveira, sou de Belo Horizonte - MG, curso Técnico em Integrado em Informática no IFMG campus Ribeirão das Neves e me formo no final de 2021.</p>
        <p className="text">Comecei na área de programação com a linguagem Python em 2018 fazendo cursos e assistindo a vídeos no YouTube. 
          ...
          <br></br><br></br>Meu atual objetivo é conseguir o meu primeiro emprego na área com alguma vaga de Estágio ou como Desenvolvedor Júnior e meu GitHub está disponível em: <a href="https://github.com/g4brieloliveira" target="_blank" rel="noopener noreferrer">https://github.com/g4brieloliveira</a>
